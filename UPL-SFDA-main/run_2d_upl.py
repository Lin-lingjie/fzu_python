...
def get_data_loader(config,dataset,target):
    ...
    if dataset == 'mms':
        ...
        train_img = data_root_fb+'/image/train'
        train_lab = data_root_fb+'/label/train'
        valid_img = data_root_fb+'/image/valid'
        valid_lab = data_root_fb+'/label/valid'
        test_img = data_root_fb+'/image/test'
        test_lab = data_root_fb+'/label/test'
